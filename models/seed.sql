...
-- Toronto RECOMMENDATIONS
    ...
    VALUES ("event", "Toronot", "CNE",2019-08-16, 2019-09-02,
    ...
    INSERT INTO Recommendations (category, city, name, startDate, endDate  description, createdAt, updatedAt)
    VALUES ("event", "Toronto", "Distillery District Christmas Market", 2019-11-15, 2019-12-23, 
    "Enjoy the tradition, heritage and charm of a European Christmas Market, right in the heart of Toronto.", CURDATE(), CURDATE());

    INSERT INTO Recommendations (category, city, name, startDate, endDate description, createdAt, updatedAt)
    VALUES ("event", "Toronto", "Honda Indy Toronto", 2019-07-12, 2019-07-14, 
...
VALUES ("Toronto", "Toronto", "http://wallpapersdsc.net/wp-content/uploads/2016/09/Toronto-full-HD.jpg", "https://www.seetorontonow.com/wp-content/uploads/2018/11/toronto-fireworks-at-nathan-phillips-square-photo-by-@nicksam368-instagram.jpg", CURDATE(), CURDATE());
